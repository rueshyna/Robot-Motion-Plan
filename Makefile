...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Dec 27 19:44:18 2010
# Project:  pro.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) lib/pro1.0.0/ && $(COPY_FILE) --parents src/headers src/headers/Algorithm.h src/headers/Data.h src/headers/MotionPlan.h src/headers/View.h lib/pro1.0.0/ && $(COPY_FILE) --parents src/sources/BFS.cc src/sources/Bitmap.cc src/sources/BitmapItem.cc src/sources/CSpace.cc src/sources/Data.cc src/sources/GraphicsItem.cc src/sources/main.cc src/sources/PainterWidget.cc src/sources/Parser.cc src/sources/PathItem.cc src/sources/Smooth.cc src/sources/Window.cc lib/pro1.0.0/ && (cd `dirname lib/pro1.0.0` && $(TAR) pro1.0.0.tar pro1.0.0 && $(COMPRESS) pro1.0.0.tar) && $(MOVE) `dirname lib/pro1.0.0`/pro1.0.0.tar.gz . && $(DEL_FILE) -r lib/pro1.0.0
...
lib/Smooth.o: src/sources/Smooth.cc src/headers/MotionPlan.h \
		src/headers/Algorithm.h \
		src/headers/Data.h \
		src/headers/View.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lib/Smooth.o src/sources/Smooth.cc
