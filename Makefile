...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Dec 13 21:25:18 2010
# Project:  pro.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) lib/pro1.0.0/ && $(COPY_FILE) --parents Algorithm.h Data.h MotionPlan.h View.h lib/pro1.0.0/ && $(COPY_FILE) --parents Bitmap.cc BitmapItem.cc CSpace.cc Data.cc GraphicsItem.cc main.cc PainterWidget.cc Parser.cc Window.cc lib/pro1.0.0/ && (cd `dirname lib/pro1.0.0` && $(TAR) pro1.0.0.tar pro1.0.0 && $(COMPRESS) pro1.0.0.tar) && $(MOVE) `dirname lib/pro1.0.0`/pro1.0.0.tar.gz . && $(DEL_FILE) -r lib/pro1.0.0
...
lib/CSpace.o: CSpace.cc MotionPlan.h \
		Data.h \
		Algorithm.h \
		View.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lib/CSpace.o CSpace.cc
